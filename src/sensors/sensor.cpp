...
#define PRINT_INTERVAL (10) // Print every 10 iterations
...
void read_sensors_th1() {
    ...
    // if (distances[i] < THRESHOLD_DISTANCE) {
    // isClose = true;
    // if (loopCounter % PRINT_INTERVAL == 0) {
    //     Serial.print("Warning: Sensor ");
    //     Serial.print(i + 1);
    //     Serial.println(" is about to hit the wall!");
    // }
    // }

    // // Print distances at a controlled interval
    // if (loopCounter % PRINT_INTERVAL == 0) {
    //     for (int i = 0; i < 6; i++) {
    //     Serial.print("Sensor ");
    //     Serial.print(i + 1);
    //     Serial.print(": ");
    //     Serial.print(distances[i], 0);
    //     Serial.println(" cm");
    //     }
    // }
